    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h1 class="modal-title fs-5 text-light" id="editaModal_usuarios_label">Editar usuario</h1>
                ...
                <form class="needs-validation" action="edita_u.php" method="post" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end justify-content-end mb-2 mt-2">
                            ...
                            <button type="submit" class="btn btn-warning">Registrar parada de bús</button>
                        </div>
