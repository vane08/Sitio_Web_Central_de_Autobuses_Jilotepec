    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h1 class="modal-title fs-5 text-light" id="nuevoModal_usuario_label">Agregar usuario</h1>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end justify-content-end mb-2 mt-2">
                                ...
                                <button type="submit" class="btn btn-dark">Registrar parada de bús</button>
                            </div>
                        </div>
                    </div>
            </div>
